...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_start.setPalette(palette1)
        font1 = QFont()
        ...
        self.pushButton_left.setPalette(palette2)
        self.pushButton_left.setFont(font2)
        ...
        self.pushButton_up.setPalette(palette3)
        self.pushButton_up.setFont(font2)
        ...
        self.pushButton_down.setPalette(palette4)
        self.pushButton_down.setFont(font2)
        ...
        self.pushButton_right.setPalette(palette5)
        self.pushButton_right.setFont(font2)
